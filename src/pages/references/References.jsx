...
function generateVectorList(row) {
    ...
    if (row.vectors) {
        row.vectors.forEach(x => {
            ...
            if (x.scopeAvId) {
                vectorString = <div> <a href={"https://khulnasoft.github.io/riex/#/attacktree?av="+x.avId} target="_blank" rel="noreferrer">[{x.avId}] {x.avName}</a> in the scope of <a href={"https://khulnasoft.github.io/riex/#/attacktree?av="+x.scopeAvId} target="_blank" rel="noreferrer">[{x.scopeAvId}] {x.scopeAvName}</a></div>
            } else {
                vectorString = <div> <a href={"https://khulnasoft.github.io/riex/#/attacktree?av="+x.avId} target="_blank" rel="noreferrer">[{x.avId}] {x.avName}</a></div>
            }
