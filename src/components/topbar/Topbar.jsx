                    ...
                    <div className="topRight">
                        <div className="topbarIcons">
                            <div className="topbarIconContainer">
                                ...
                                <span className="logo">
                                    <a className="logo"  href="https://github.com/KHULNASOFT/risk-explorer-for-software-supply-chains" target="_blank" rel="noreferrer"><GitHubIcon style={{fontSize: "30px",marginTop:"45%"}}></GitHubIcon></a>
                                </span>
